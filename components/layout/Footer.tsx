        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://www.linkedin.com/company/balbirdindustries/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-accent transition-colors" aria-label="LinkedIn">
                  <Linkedin size={16} />
                  <span>LinkedIn</span>
                </a>
              </li>
