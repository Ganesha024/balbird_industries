...
export default function IntelligentOrderProcurementPage() {
  return (
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-16 text-center animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-foreground mb-6 tracking-tight leading-[1.1] text-center mx-auto">
            ...
            <span className="text-accent">Procurement Automation</span>
          </h1>
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="w-full lg:w-1/2 h-full min-h-[360px] p-8 rounded-2xl border border-border bg-card shadow-xl flex flex-col items-center justify-center gap-6 relative overflow-hidden">
              <div className="absolute top-1/2 left-[10%] right-[10%] h-0.5 bg-border -translate-y-1/2 z-0" />
              <div className="absolute top-1/2 left-[10%] w-[45%] h-0.5 bg-accent -translate-y-1/2 z-0 animate-[pulse_2s_ease-in-out_infinite]" />
              ...
              <p className="text-xs text-foreground/50 text-center max-w-xs relative z-10">
